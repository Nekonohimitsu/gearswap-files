...
function init_gear_sets()	
    ...
    sets.midcast.Cure = {
		...
		neck="Orunmila's Torque", ear1="Enervating Earring", ear2="Lethargy Earring",
		body="Kaykaus Bliaut", hands="Kaykaus Cuffs +1", ring1="Lebeche Ring", ring2="Mephitas's Ring +1", 
